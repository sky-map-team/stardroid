...
## 1. Summary
Sky Map comes with **no warranties**. While we can think of no conceivable way it could harm your phone or you (except perhaps giving you a neck ache from looking up at the sky), you are using it entirely at your own risk.

---

## 2. Using Sky Map
* **Intellectual Property:** Using Sky Map does not give you ownership of any intellectual property rights over the content you access.
* **Content Usage:** You may not use content from Sky Map unless you obtain permission from its owners (see in-app help/acknowledgments) or are otherwise permitted by law.
* **Branding:** These terms do not grant you the right to use any branding or logos used in Sky Map.
* **Legal Notices:** Do not remove, obscure, or alter any legal notices displayed in or along with the App.
...
## 8. About These Terms
* **Modifications:** We may modify these terms to reflect changes to the law or the App. Updated terms will be shown in the App. If you do not agree to modified terms, you should discontinue use.
* **No Waiver:** If you do not comply with these terms and we don't take action right away, we are not giving up any rights (such as taking action in the future).
* **Severability:** If a particular term is not enforceable, it will not affect any other terms.
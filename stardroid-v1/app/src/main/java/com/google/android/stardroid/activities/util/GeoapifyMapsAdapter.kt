...
class GeoapifyMapsAdapter @Inject constructor(
    ...
    override fun updateLocation(location: LatLong) {
        ...
        // https://maps.geoapify.com/v1/staticmap?style=dark-matter&width={width}&height={height}&center=lonlat:{lon},{lat}&zoom=11&marker=lonlat:{lon},{lat};color:red&apiKey={key}

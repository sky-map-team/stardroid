...
public class MeteorShowerLayer extends AbstractSourceLayer {
  ...
  private static class Shower {
    private Date start;
    private Vector3 radiant;
    private int nameId;
    private Date peak;
    private Date end;
    private int peakMeteorsPerHour;

    public Shower(String name, int nameId, Vector3 radiant,

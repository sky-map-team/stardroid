...
library in `gradle/libs.versions.toml`, no `Build.VERSION_CODES` check in the app — actually
*requires* API 29; the floor was a maintenance boundary, not a technical dependency. D9 is
now: **`minSdk 28`, Android 9 support is best-effort and unsupported.**

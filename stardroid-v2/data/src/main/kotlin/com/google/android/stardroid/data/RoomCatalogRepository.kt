...
class RoomCatalogRepository(
    ...
    override suspend fun searchByPrefix(
        ...
        val rankedOrder =
            matchQuality
                // Unlayered objects (Sun, Moon, planets) outrank layered ones at equal match
                // quality: they're searched far more often than stars, yet rarely carry a fixed
                // magnitude to sort by (#1016).
